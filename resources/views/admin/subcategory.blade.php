...
@section('javascript')
<script type="text/javascript" src="{{ URL::to('ajax/subcategory.js') }}"></script>
@stop
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">New Subcategory</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                        <div class="form-line">
                            <input type="text" name="name" id="category" class="form-control" placeholder="Enter the Brand Name">
                        </div>
                    </div>
            </div>
